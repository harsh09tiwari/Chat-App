...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hello, this is a preview message.", isSent: false },
  { id: 2, content: "Another preview message for testing.", isSent: true }
];

const SettingsPage = () => {

  const {theme, setTheme} = useThemeStore();  //  get the theme and setTheme from the store
    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-4xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1 ">
          ...
          <p className="text-lg text-base-content/80">Choose a theme for your App Interface</p>
        </div>
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-7 gap-2.5">
          ...
          <button 
            key={t}
            className={`group flex flex-col items-center rounded-lg gap-1.5 p-2 transition-colors ${theme === t ? "bg-base-200" : "hover:bg-base-200/50"}`}
            onClick={() => setTheme(t)}
          >
            <div className="relative h-8 w-full rounded-xl overflow-hidden" data-theme={t}>
                ...
                <div className="absolute inset-0 grid grid-cols-4 gap-px p-2">
                  ...
                  <div className="rounded-xl bg-neutral"></div>
                </div>
              </div>
